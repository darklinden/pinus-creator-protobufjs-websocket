...
export const proto = (function() {
    ...
    proto.Bar = (function() {
        ...
        Bar.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new proto.Bar();
        ...
        Bar.fromObject = function fromObject(object) {
            if (object instanceof proto.Bar)
                return object;
            var message = new proto.Bar();
            if (object.bar != null)
    ...
    proto.Foo = (function() {
        ...
        Foo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new proto.Foo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Foo.fromObject = function fromObject(object) {
            if (object instanceof proto.Foo)
                return object;
            var message = new proto.Foo();
            if (object.foo != null)
    ...
    proto.LargeNumber = (function() {
        ...
        LargeNumber.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new proto.LargeNumber();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
